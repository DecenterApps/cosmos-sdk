...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, cdc *codec.Codec, kb keys.Keybase) {
	...
	r.HandleFunc("/bank/accounts/{address}/signer", AddSignerRequestHandlerFn(cdc, kb, cliCtx)).Methods("POST")
...
func SendRequestHandlerFn(cdc *codec.Codec, kb keys.Keybase, cliCtx context.CLIContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		msg := client.CreateSendMsg(sdk.AccAddress(info.GetPubKey().Address()), req.From, to, req.Amount)
