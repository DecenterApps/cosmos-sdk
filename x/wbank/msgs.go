...
func NewMsgSend(signer sdk.AccAddress, in []Input, out []Output) MsgSend {
	return MsgSend{Signer: signer, Inputs: in, Outputs: out}
}
...
func (msg MsgSend) ValidateBasic() sdk.Error {
	...
	if IsSigner(msg.Signer) {
		return ErrNotASigner(DefaultCodespace).TraceSDK("")
	}
	if len(msg.Inputs) == 0 {
...
// NewMsgSend - construct arbitrary multi-in, multi-out send msg.
func NewMsgAddSigner(from, signer sdk.AccAddress) MsgAddSigner {
	return MsgAddSigner{From: from, Signer: signer}
}

// Implements Msg.
func (msg MsgAddSigner) Route() string { return "bank" }

// Implements Msg.
func (msg MsgAddSigner) Type() string { return "add-signer" }
...
// Implements Msg.
func (msg MsgAddSigner) GetSigners() []sdk.AccAddress {
