...
const (
	...
	CodeNotASigner    sdk.CodeType = 102
	CodeInvalidOutput sdk.CodeType = 103
)
...
func ErrNotASigner(codespace sdk.CodespaceType) sdk.Error {
	return newError(codespace, CodeNotASigner, "")
}
