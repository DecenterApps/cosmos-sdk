...
import (
	...
	bankcmd "github.com/cosmos/cosmos-sdk/x/wbank/client/cli"
	ibccmd "github.com/cosmos/cosmos-sdk/x/wibc/client/cli"
...
func main() {
	...
	rootCmd.AddCommand(
		client.PostCommands(
			...
			bankcmd.AddSigner(cdc),
			ibccmd.IBCTransferCmd(cdc),
			ibccmd.DepositLockCmd(cdc),
